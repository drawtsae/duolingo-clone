...
//Main
const TracnghiemSecondPronuciationUnit1 = ({navigation}) => {
    ...
    //Update
    const [value, Setvalue] = useState('66.7%'); // Thong so thay doi
    const update = async() =>{
        //update vocabulary
        if (userData?.PronuciationUnit1 == "33.3%" || userData?.PronuciationUnit1 == "0%"){ //
    ...
    const buttonKtra =() =>
    {
        ...
        return(
            ...
            <View >
            <TouchableOpacity 
            onPress={()=>{update(), navigation.navigate('TracnghiemThirtPronuciationUnit1')}}
            style={{height:60,width:130, backgroundColor:'green', borderRadius:20, margin:20, alignItems:'center', justifyContent:'center'}}>
...
export default TracnghiemSecondPronuciationUnit1