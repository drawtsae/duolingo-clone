...
//Main
const TracnghiemFirstPronuciationUnit1 = ({navigation}) => {
    ...
    //Update
    const [value, Setvalue] = useState('33.3%');
    const update = async() =>{
        //update vocabulary
        if (userData?.PronuciationUnit1 == "0%"){
    ...
    const buttonKtra =() =>
    {
        ...
        return(
            ...
            <View >
            <TouchableOpacity 
            onPress={()=>{update(), navigation.navigate('TracnghiemSecondPronuciationUnit1')}}
            style={{height:60,width:130, backgroundColor:'green', borderRadius:20, margin:20, alignItems:'center', justifyContent:'center'}}>
...
export default TracnghiemFirstPronuciationUnit1